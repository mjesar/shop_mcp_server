...
--
-- Name: index_orders_on_customer_email; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_orders_on_customer_email ON public.orders USING btree (customer_email);
...
CREATE INDEX index_products_on_title ON public.products USING btree (title);
